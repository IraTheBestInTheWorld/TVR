...
public class Level10_2 extends AppCompatActivity {
    ...
    public void popUpEnd(){
        ...
        dialog1.setContentView(R.layout.popup_level10_end);
        dialog1.setTitle(" ");
        // set the custom dialog components - text, image and button
        TextView text = (TextView) dialog1.findViewById(R.id.level10_text_end);
        ...
        ImageView image3 = (ImageView) dialog1.findViewById(R.id.level10_popup);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level10_2);
        Window w = getWindow();
        ...
        TextView.OnClickListener onClickListenerForWords = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(hintIsActive[0] == true) {
                    ...
                    if (word == ntg_2) {
                        letter3.setTextColor(Color.parseColor("#59A905"));
                        letter3.setTextSize(40);
                        Typeface typeface = getResources().getFont(R.font.nunito_black);
                        letter3.setTypeface(typeface);
                        hintIsActive[0] = false;
        ...
        StringBuilder[] hiddenWords = {new StringBuilder("VERDAD"), new StringBuilder("NINOS"), new StringBuilder("BUENO")};
