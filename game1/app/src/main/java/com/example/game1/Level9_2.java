...
public class Level9_2 extends AppCompatActivity {
    ...
    public void popUpEnd(){
        ...
        dialog1.setContentView(R.layout.popup_level9_end);
        dialog1.setTitle(" ");
        // set the custom dialog components - text, image and button
        TextView text = (TextView) dialog1.findViewById(R.id.level9_text_end);
        ...
        ImageView image3 = (ImageView) dialog1.findViewById(R.id.level9_popup);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView.OnClickListener onClickListenerForWords = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(hintIsActive[0] == true) {
                    ...
                    if (word == ntg_2) {
                        letter6.setTextColor(Color.parseColor("#59A905"));
                        letter6.setTextSize(40);
                        Typeface typeface = getResources().getFont(R.font.nunito_black);
                        letter6.setTypeface(typeface);
                        hintIsActive[0] = false;
                        ntg_2.setEnabled(false);
                    }

                    if (word == ntg_3) {
                        letter4.setTextColor(Color.parseColor("#59A905"));
                        letter4.setTextSize(40);
                        Typeface typeface = getResources().getFont(R.font.nunito_black);
                        letter4.setTypeface(typeface);
                        hintIsActive[0] = false;
        ...
        StringBuilder[] hiddenWords = {new StringBuilder("POTION"), new StringBuilder("MAINS"), new StringBuilder("ASSEZ")};
