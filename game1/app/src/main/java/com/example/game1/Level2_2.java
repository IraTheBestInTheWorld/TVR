...
public class Level2_2 extends AppCompatActivity {
    ...
    public void popUpEnd(){
        ...
        dialogButton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                 try {
                    Intent intent = new Intent(Level2_2.this, Level3_1.class );
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView.OnClickListener onClickListenerForWords = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(hintIsActive[0] == true) {
                    ...
                    if (word == ntg_2) {
                        letter11.setTextColor(Color.parseColor("#59A905"));
                        letter11.setTextSize(40);
                        Typeface typeface = getResources().getFont(R.font.nunito_black);
                        letter11.setTypeface(typeface);
                        hintIsActive[0] = false;
                        ntg_2.setEnabled(false);
                    }

                    if (word == ntg_3) {
                        letter9.setTextColor(Color.parseColor("#59A905"));
                        letter9.setTextSize(40);
                        Typeface typeface = getResources().getFont(R.font.nunito_black);
                        letter9.setTypeface(typeface);
                        hintIsActive[0] = false;
        ...
        StringBuilder[] hiddenWords = {new StringBuilder("MOTHER"), new StringBuilder("FATHER"), new StringBuilder("WAND")};
